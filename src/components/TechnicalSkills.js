      ...
      <div className="flex gap-7 flex-wrap items-center justify-center py-6">
        <div className="flex flex-col items-center">
          ...
          <div className="ring-2 dark:ring-gray-800 ring-slate-300 rounded-xl grid grid-cols-2 md:grid-cols-3 gap-4 p-5 lg:pt-10">
            <div className="text-sm tech-container bg-white drop-shadow-xl dark:bg-gray-800 bg-opacity-60 px-9 py-7 rounded-lg hover:bg-gray-200 dark:hover:bg-white transition-colors duration-200 ease-in-out flex flex-col justify-center items-center gap-2">
